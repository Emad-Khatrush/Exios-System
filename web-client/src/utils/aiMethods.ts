export const generateMessageForAirShipping = (passedDays: number) => {
  ...
  if (remainingDays >= 1) {
    ...
    return `نتأسف على التأخير الخارج عن ارادتنا عميلنا العزيز، ولانك عزيز علينا ستتحصل على كوبون خصم على رحلتك وكوبون خصم شراء، تواصل مع الشركة وقم بارسال صوره من هذه الرسالة وسيتم منحك كوبون حصري لك، بخصوص الشحنه يمكنك الاستفسار مباشرة عن حالة الشحنه عبر تواصل مع اقرب فرع لمنطقتك، شكرا لتفاهمك`
  }
}
